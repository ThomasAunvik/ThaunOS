// Terminus Font 8x16 (ter-u16n) - Normal weight
// Copyright (C) 2014 Dimitar Toshkov Zhekov
// Licensed under the SIL Open Font License, Version 1.1
// Source: https://github.com/Tecate/bitmap-fonts

const GLYPH_HEIGHT: usize = 16;
const GLYPH_COUNT: usize = 95; // chars 32..=126

/// Terminus 8×16 bitmap glyphs for characters 32 (' ') through 126 ('~').
#[rustfmt::skip]
...
static FALLBACK: [u8; GLYPH_HEIGHT] = [0x00, 0x00, 0xfe, 0xfe, 0xfe, 0xfe, 0xfe, 0xfe, 0xfe, 0xfe, 0xfe, 0xfe, 0xfe, 0xfe, 0x00, 0x00];
